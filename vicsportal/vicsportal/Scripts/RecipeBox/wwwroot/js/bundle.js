...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RecipeBox = function (_React$Component) {
		...
		_createClass(RecipeBox, [{
			key: 'showRecipeModal',
			value: function showRecipeModal() {
	...
	_reactDom2.default.render(_react2.default.createElement(RecipeBox, null), document.querySelector(".myapp"));
